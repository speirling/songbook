...
<div class="playlists playlist-edit-form form large-10 medium-9 columns content">
    ...
    <fieldset>
        ...
        <span class="playlist-title"><?= $this->Form->control('title', ['div'=>'playlist-title']) ?></span>
        <span class="playlist-performer-id"><?= $this->Form->control('performer_id') ?></span>
                    ...
                    <table cellpadding="0" cellspacing="0" class="set-songs setSongs sortable" setnumber="<?= $playlistSets->set->id; ?>">
                        ...
                        <tr>
                            <td class="set-song-key set-song-capo">
                                ...
                                <span class="key"><?= $this->Form->control('key', ['label'=> false, 'value'=>h($setSongs->key)]) ?></span>
                                <span class="capo"><span>(</span><?= $this->Form->control('capo', ['label'=> false, 'value'=>h($setSongs->capo), 'type'=> 'text']) ?><span>)</span></span>
                            </td>
                        ...
                        <div class="set-add-new-song-ui add-new-ui" add_text="Song">
                            <div class="add-song form">
                                ...
                                <fieldset>
                                    <?php
                                        echo '<span class="playlist-song-id">'.$this->Form->control('song_id', ['label'=> '', 'empty' => 'Song Title ...', 'options' => $songs]).'</span>';
                                        echo '<span class="playlist-performer-id">'.$this->Form->control('performer_id', ['label'=> '', 'empty' => 'Performer ...', 'options' => $performers]).'</span>';
                                        echo '<span class="playlist-key">'.$this->Form->control('key', ['label'=> false, 'placeholder' => 'Key']).'</span>';
                                        echo '<span class="playlist-capo">'.$this->Form->control('capo', ['label'=> false, 'placeholder' => 'Capo', 'min' => 0, 'max' => 14]).'</span>';
                            ...
                            <div class="add-new-song form">
                                ...
                                <fieldset>
                                    <?php
                                        echo '<span class="playlist-new-song-title">'.$this->Form->control('title', ['label'=> false, 'placeholder' => 'Song Title']).'</span>';
                                        echo '<span class="playlist-new-song-performed-by">'.$this->Form->control('performed_by', ['label'=> false, 'placeholder' => 'Who sang this song?']).'</span>';
                                        echo '<span class="playlist-performer-id">'.$this->Form->control('performer_id', ['label'=> '', 'empty' => 'Performer ...', 'options' => $performers]).'</span>';
                                        echo '<span class="playlist-key">'.$this->Form->control('key', ['label'=> false, 'placeholder' => 'Key']).'</span>';
                                        echo $this->Form->hidden('set_id', ['value' => $playlistSets->set->id]);
                                        echo $this->Form->hidden('order', ['value' => sizeof($playlistSets->set->set_songs) + 1]);
    ...
    <div class="playlist-add-new-set-ui add-new-ui" add_text="Set">
        <div class="playlistSets form">
            ...
            <fieldset>
                <?php
                    echo $this->Form->control('set_id', ['empty' => 'Please select ...', 'options' => $sets, 'label' => false]);
        ...
        <div class="sets form ">
            ...
            <fieldset>
                <?php
                    echo '<span class="inlinetop">'.$this->Form->control('title',['label'=> false, 'placeholder' => 'Set Title']).'</span>';
                    echo '<span class="inlinetop">'.$this->Form->control('performer_id', ['options' => $performers, 'value' => $playlist->performer_id, 'label'=> false, 'empty' => 'Performer ...']).'</span>';
                    //echo '<span class="inlinetop playlist-new-set-comment">'.$this->Form->control('comment',['label'=> false, 'placeholder' => 'Comment']).'</span>';
                    echo $this->Form->hidden('order', ['value' => sizeof($playlist->playlist_sets) + 1]);
                    echo $this->Form->hidden('playlist_id', ['value' => $playlist->id]);
                ?>
            </fieldset>
