<div class="setSongs index">
	<h2><?php echo __('Set Songs'); ?></h2>
	...
	<tr>
		<td><?php echo h($setSong['SetSong']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($setSong['SetSong']['order']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $setSong['SetSong']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $setSong['SetSong']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $setSong['SetSong']['id']), array(), __('Are you sure you want to delete # %s?', $setSong['SetSong']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
