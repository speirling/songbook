SBK.SongbookApplication = SBK.Class.extend({
    ...
    _display_song: function (id, key, capo) {
        ...
        self.container.html('');
        self.content_container = jQuery('<div class="lyrics-page zoom-2 lyrics-display"></div>').appendTo(self.container);
    ...
    _display_playlist_list: function () {
        ...
        new SBK.Button(button_bar, 'add-new-song', 'Add a new Song', function () {window.open('/songbook/songs/add/','_blank');}),
        new SBK.Button(button_bar, 'all-songs', 'All songs (cake)', function () {window.open('/songbook/songs/','_blank');}),
